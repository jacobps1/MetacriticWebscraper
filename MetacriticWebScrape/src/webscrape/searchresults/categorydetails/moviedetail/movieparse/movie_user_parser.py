...
from webscrape.searchresults.categorydetails.moviedetail.movieparse.movie_review import movie_review

'''
Represents the object that parses the user reviews from a given movie on metacritic
'''
class movie_user_parser(object):
    
    '''
    Constructor for Movie_User_Parser object
    Parameters:
        link represents the link (url) of the movie's user reviews
    '''
    ...
    def _get_reviews(self):
        ...
        review = movie_review(current_review) 
