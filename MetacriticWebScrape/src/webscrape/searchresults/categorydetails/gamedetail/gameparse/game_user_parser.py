...
from webscrape.searchresults.categorydetails.gamedetail.gameparse.game_review import game_review

class game_user_parser(object):
    
    '''
    Constructor for Game_User_Parser object
    Parameters:
        link represents the link (url) of the game's user reviews
    '''
    ...
    def _get_reviews(self):
        ...
        #create the game_review object that will parse the review
        review = game_review(current_review) 
