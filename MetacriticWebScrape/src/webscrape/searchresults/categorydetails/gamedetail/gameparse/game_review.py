...
class game_review(object):
    ...
    def _begin_parse(self):
        ...
        def parse_year():
            ...
            start_index = self.html.find("<div class=\"date\">") + len("<div class=\"date\">")
        ...
        def parse_summary():
            ...
            start_index = self.html.find("<div class=\"review_body\">") + len("<div class=\"review_body\">")
            html = self.html[start_index:]
            end_index = html.find("</div>")
            html = html[:end_index]
        ...
        def parse_helpful():
            ...
            start_index = self.html.find("<span class=\"total_ups\">") + len("<span class=\"total_ups\">")
            html = self.html[start_index:]
            ...
            start_index = html.find("<span class=\"total_thumbs\">") + len("<span class=\"total_thumbs\">")
            html = html[start_index:]
